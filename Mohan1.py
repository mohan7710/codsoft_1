...
test_data=pd.read_csv(r"C:\Users\yvmad\Downloads\archive\Genre Classification Dataset\test_data.txt",sep=':::',engine='python')
test_data_solution=pd.read_csv(r"C:\Users\yvmad\Downloads\archive\Genre Classification Dataset\test_data_solution.txt",sep=':::',engine='python')
train_data=pd.read_csv(r"C:\Users\yvmad\Downloads\archive\Genre Classification Dataset\train_data.txt",sep=":::",engine='python')
